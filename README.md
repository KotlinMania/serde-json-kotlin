# serde-json-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Fserde--json--kotlin-blue.svg)](https://github.com/KotlinMania/serde-json-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/serde-json-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/serde-json-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/serde-json-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/serde-json-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`serde-rs/json`](https://github.com/serde-rs/json).

**Original Project:** This port is based on [`serde-rs/json`](https://github.com/serde-rs/json). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `serde-rs/json`

> The text below is reproduced and lightly edited from [`https://github.com/serde-rs/json`](https://github.com/serde-rs/json). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
This Kotlin port is distributed under the same MIT license as the upstream [`serde-rs/json`](https://github.com/serde-rs/json). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.

Original work copyrighted by the json authors.  
Kotlin port: Copyright (c) 2026 Sydney Renee and The Solace Project.

### Acknowledgments

Thanks to the [`serde-rs/json`](https://github.com/serde-rs/json) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
