...
This file is the quick-reference operating contract for serde-json-kotlin. The longer
...
serde-json-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`serde_json`](https://crates.io/crates/serde_json). Upstream Rust is the behavioral oracle while the
