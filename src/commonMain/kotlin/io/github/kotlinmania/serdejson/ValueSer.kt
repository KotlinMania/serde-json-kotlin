 ...
 */
private class ValueVec : SerializeSeq<Value>, SerializeTuple<Value>, SerializeTupleStruct<Value> {
 ...
 */
private class ValueTupleVariant(private val name: String) : SerializeTupleVariant<Value> {
    private val list = mutableListOf<Value>()
    ...
    override fun end(): SerdeResult<Value> = serdeCatching {
        val map = ValueMap()
 ...
 */
private class ValueMapSerialize : SerializeMap<Value>, SerializeStruct<Value> {
 ...
 */
private class ValueStructVariant(private val name: String) : SerializeStructVariant<Value> {
    private val map = ValueMap()
