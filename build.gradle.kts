...
kotlin {
    ...
    val xcf = XCFramework("SerdeJson")

    macosArm64 {
        binaries.framework { baseName = "SerdeJson"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "SerdeJson"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "SerdeJson"
        flattenPackage = "io.github.kotlinmania.serdejson"
    }

    android {
        namespace = "io.github.kotlinmania.serdejson"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "serde-json-kotlin", version.toString())

    pom {
        name.set("serde-json-kotlin")
        description.set("Kotlin Multiplatform port of serde-rs/json - A JSON serialization file format")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/serde-json-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/serde-json-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/serde-json-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/serde-json-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.serdejson.codeql
