...
- **Function parity:** 278/619 matched (target 494) — 44.9%
- **Class/type parity:** 20/161 matched (target 111) — 12.4%
- **Combined symbol parity:** 298/780 matched (target 605) — 38.2%
...
- **Provenance warning:** port-lint provenance header matched only by basename: `tests:tests/map.rs` vs expected `map.rs`
- **Proposed provenance header:** `// port-lint: source map.rs` (current: `// port-lint: source src/map.rs`)
- **Proposed provenance header:** `// port-lint: tests map.rs` (current: `// port-lint: tests tests/map.rs`)
- **Lint issues:** 2
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `src/number.rs` vs expected `number.rs`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:src/number.rs` vs expected `number.rs`
- **Proposed provenance header:** `// port-lint: source number.rs` (current: `// port-lint: source src/number.rs`)
- **Proposed provenance header:** `// port-lint: tests number.rs` (current: `// port-lint: tests src/number.rs`)
- **Lint issues:** 2
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `src/de.rs` vs expected `de.rs`
- **Proposed provenance header:** `// port-lint: source de.rs` (current: `// port-lint: source src/de.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `src/value/index.rs` vs expected `value/index.rs`
- **Proposed provenance header:** `// port-lint: source value/index.rs` (current: `// port-lint: source src/value/index.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tmp/serde_json/src/lexical/cached_float80.rs` vs expected `lexical/cached_float80.rs`
- **Proposed provenance header:** `// port-lint: source lexical/cached_float80.rs` (current: `// port-lint: source tmp/serde_json/src/lexical/cached_float80.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `src/ser.rs` vs expected `ser.rs`
- **Proposed provenance header:** `// port-lint: source ser.rs` (current: `// port-lint: source src/ser.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `src/raw.rs` vs expected `raw.rs`
- **Proposed provenance header:** `// port-lint: source raw.rs` (current: `// port-lint: source src/raw.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `src/value/de.rs` vs expected `value/de.rs`
- **Proposed provenance header:** `// port-lint: source value/de.rs` (current: `// port-lint: source src/value/de.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `src/read.rs` vs expected `read.rs`
- **Proposed provenance header:** `// port-lint: source read.rs` (current: `// port-lint: source src/read.rs`)
- **Lint issues:** 1
...
- **Target:** `serdejson.Value [STUB] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 0
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `src/value/mod.rs` vs expected `value/mod.rs`
- **Proposed provenance header:** `// port-lint: source value/mod.rs` (current: `// port-lint: source src/value/mod.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tmp/serde_json/src/lexical/math.rs` vs expected `lexical/math.rs`
- **Provenance warning:** port-lint provenance header matched only by basename: `tests:tests/lexical/math.rs` vs expected `lexical/math.rs`
- **Proposed provenance header:** `// port-lint: source lexical/math.rs` (current: `// port-lint: source tmp/serde_json/src/lexical/math.rs`)
- **Proposed provenance header:** `// port-lint: tests lexical/math.rs` (current: `// port-lint: tests tests/lexical/math.rs`)
- **Lint issues:** 2
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tmp/serde_json/src/lexical/num.rs` vs expected `lexical/num.rs`
- **Proposed provenance header:** `// port-lint: source lexical/num.rs` (current: `// port-lint: source tmp/serde_json/src/lexical/num.rs`)
- **Lint issues:** 1
...
- **Types:** 1/1 matched
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tmp/serde_json/src/lexical/bignum.rs` vs expected `lexical/bignum.rs`
- **Proposed provenance header:** `// port-lint: source lexical/bignum.rs` (current: `// port-lint: source tmp/serde_json/src/lexical/bignum.rs`)
- **Lint issues:** 1
...
- **Types:** 0/0 matched
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tmp/serde_json/src/lexical/rounding.rs` vs expected `lexical/rounding.rs`
- **Proposed provenance header:** `// port-lint: source lexical/rounding.rs` (current: `// port-lint: source tmp/serde_json/src/lexical/rounding.rs`)
- **Lint issues:** 1
...
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tmp/serde_json/src/lexical/cached.rs` vs expected `lexical/cached.rs`
- **Proposed provenance header:** `// port-lint: source lexical/cached.rs` (current: `// port-lint: source tmp/serde_json/src/lexical/cached.rs`)
- **Lint issues:** 1
...
- **Types:** 0/0 matched
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `src/value/partial_eq.rs` vs expected `value/partial_eq.rs`
- **Proposed provenance header:** `// port-lint: source value/partial_eq.rs` (current: `// port-lint: source src/value/partial_eq.rs`)
- **Lint issues:** 1
...
- **Types:** 0/0 matched
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tmp/serde_json/src/lexical/bhcomp.rs` vs expected `lexical/bhcomp.rs`
- **Proposed provenance header:** `// port-lint: source lexical/bhcomp.rs` (current: `// port-lint: source tmp/serde_json/src/lexical/bhcomp.rs`)
- **Lint issues:** 1
...
- **Types:** 0/0 matched
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `src/value/from.rs` vs expected `value/from.rs`
- **Proposed provenance header:** `// port-lint: source value/from.rs` (current: `// port-lint: source src/value/from.rs`)
- **Lint issues:** 1
...
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tmp/serde_json/src/lexical/errors.rs` vs expected `lexical/errors.rs`
- **Proposed provenance header:** `// port-lint: source lexical/errors.rs` (current: `// port-lint: source tmp/serde_json/src/lexical/errors.rs`)
- **Lint issues:** 1
...
- **Types:** 0/0 matched
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tmp/serde_json/src/lexical/algorithm.rs` vs expected `lexical/algorithm.rs`
- **Proposed provenance header:** `// port-lint: source lexical/algorithm.rs` (current: `// port-lint: source tmp/serde_json/src/lexical/algorithm.rs`)
- **Lint issues:** 1
...
- **Types:** 0/0 matched
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tmp/serde_json/src/lexical/shift.rs` vs expected `lexical/shift.rs`
- **Proposed provenance header:** `// port-lint: source lexical/shift.rs` (current: `// port-lint: source tmp/serde_json/src/lexical/shift.rs`)
- **Lint issues:** 1

### 25. macros

- **Target:** `serdejson.Macros [ZERO] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 0
- **Priority Score:** 10.0
...
- **Target:** `lexical.Lexical [STUB] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 0
- **Priority Score:** 10.0
...
- **Types:** 0/0 matched (target 1)
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `src/lexical/mod.rs` vs expected `lexical/mod.rs`
- **Proposed provenance header:** `// port-lint: source lexical/mod.rs` (current: `// port-lint: source src/lexical/mod.rs`)
- **Lint issues:** 1

### 27. lib

- **Target:** `serdejson.Lib [STUB] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 0
- **Priority Score:** 10.0
...
- **Target:** `serdejson.Io [STUB] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 0
- **Priority Score:** 10.0
...
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `src/io/mod.rs` vs expected `io/mod.rs`
- **Proposed provenance header:** `// port-lint: source io/mod.rs` (current: `// port-lint: source src/io/mod.rs`)
- **Lint issues:** 1
...
- **Types:** 0/0 matched
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tmp/serde_json/src/lexical/large_powers64.rs` vs expected `lexical/large_powers64.rs`
- **Proposed provenance header:** `// port-lint: source lexical/large_powers64.rs` (current: `// port-lint: source tmp/serde_json/src/lexical/large_powers64.rs`)
- **Lint issues:** 1
